...
(1/4) Checking inputs.
Dropping 12174 samples from the metadata (out of 12870 in total) not present in the tree.
...
Chain 4 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
Chain 4 
Warning: 77 of 4000 (2.0%) transitions hit the maximum treedepth limit of 10.
