...
(1/4) Checking inputs.
Dropping 12622 samples from the metadata (out of 12870 in total) not present in the tree.
...
Chain 1 Exception: normal_id_glm_lpdf: Intercept[1] is inf, but must be finite! (in '/tmp/RtmpiAe9mj/model-a9322f6cef67.stan', line 38, column 2 to column 62)
