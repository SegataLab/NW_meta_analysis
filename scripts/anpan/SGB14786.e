...
(1/4) Checking inputs.
Dropping 7 tips from the tree (out of 161) not present in the metadata.
Dropping 12716 samples from the metadata (out of 12870 in total) not present in the tree.
