...
(1/4) Checking inputs.
Dropping 51 tips from the tree (out of 143) not present in the metadata.
Dropping 12778 samples from the metadata (out of 12870 in total) not present in the tree.
