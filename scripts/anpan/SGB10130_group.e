...
(1/4) Checking inputs.
Dropping 21 tips from the tree (out of 168) not present in the metadata.
Dropping 12723 samples from the metadata (out of 12870 in total) not present in the tree.
...
Chain 4 
Warning: 38 of 4000 (1.0%) transitions ended with a divergence.
